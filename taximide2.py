# esta versión crea los archivos password.json, taximetro.db y taximideapp.log en la misma carpeta que el archivo taximide2.py
import hashlib 
import re    
import os
...
# Definir las rutas de los archivos basadas en el directorio actual
password_path = os.path.join(current_dir, "password.json")
db_path = os.path.join(current_dir, "taximetro.db")
log_path = os.path.join(current_dir, "taximideapp.log")
